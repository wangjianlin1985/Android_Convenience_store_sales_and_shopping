...
public class ShopCartAction extends BaseAction {
    ...
    public String AddShopCart() {
        ...
        try {
            ...
            ctx.put("message",  java.net.URLEncoder.encode("ShopCart添加成功!"));
            return "add_success";
            ...
            e.printStackTrace();
            ctx.put("error",  java.net.URLEncoder.encode("ShopCart添加失败!"));
            return "error";
        }
    }
...
shopCart.getPrice() + "",shopCart.getBuyNum() + ""});
    ...
    public String ModifyShopCart() {
        ...
        try {
            ...
            ctx.put("message",  java.net.URLEncoder.encode("ShopCart信息更新成功!"));
            return "modify_success";
        } catch (Exception e) {
            e.printStackTrace();
            ctx.put("error",  java.net.URLEncoder.encode("ShopCart信息更新失败!"));
            return "error";
       }
   }
    ...
    public String DeleteShopCart() {
        ...
        try { 
            ...
            ctx.put("message",  java.net.URLEncoder.encode("ShopCart删除成功!"));
            return "delete_success";
        } catch (Exception e) { 
            e.printStackTrace();
            ctx.put("error",  java.net.URLEncoder.encode("ShopCart删除失败!"));
            return "error";
        }
    }
