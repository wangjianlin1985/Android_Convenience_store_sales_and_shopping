...
public class UserInfoAction extends BaseAction {
    ...
    public String QueryUserInfo() {
        ...
        List<UserInfo> userInfoList = userInfoDAO.QueryUserInfoInfo(user_name, name, birthDate, telephone, currentPage);
        /*计算总的页数和总的记录数*/
        userInfoDAO.CalculateTotalPageAndRecordNumber(user_name, name, birthDate, telephone);
        /*获取到总的页码数目*/
    ...
    public String QueryUserInfoOutputToExcel() { 
        ...
        if(birthDate == null) birthDate = "";
        if(telephone == null) telephone = "";
        List<UserInfo> userInfoList = userInfoDAO.QueryUserInfoInfo(user_name,name,birthDate,telephone);
        ...
        for(int i=0;i<userInfoList.size();i++) {
        	...
        	dataset.add(new String[]{userInfo.getUser_name(),userInfo.getName(),userInfo.getGender(),new SimpleDateFormat("yyyy-MM-dd").format(userInfo.getBirthDate()),userInfo.getUserPhoto(),userInfo.getTelephone(),userInfo.getEmail(),userInfo.getRegTime()});
        }
        /*
