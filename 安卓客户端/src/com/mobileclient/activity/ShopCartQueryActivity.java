...
public class ShopCartQueryActivity extends Activity {
	// 声明查询按钮
	...
	/*查询过滤条件保存到这个对象中*/
	private ShopCart queryConditionShopCart = new ShopCart();
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// 设置当前Activity界面布局
		setContentView(R.layout.shopcart_query);
		ImageView search = (ImageView) this.findViewById(R.id.search);
		search.setVisibility(View.GONE);
		TextView title = (TextView) this.findViewById(R.id.title);
		title.setText("设置购物车查询条件");
		...
		spinner_productObj.setOnItemSelectedListener(new OnItemSelectedListener() {
			...
			public void onItemSelected(AdapterView<?> arg0, View arg1,int arg2, long arg3) {
				if(arg2 != 0)
					queryConditionShopCart.setProductObj(productList.get(arg2-1).getProductId()); 
				else
		...
		spinner_userObj.setOnItemSelectedListener(new OnItemSelectedListener() {
			...
			public void onItemSelected(AdapterView<?> arg0, View arg1,int arg2, long arg3) {
				if(arg2 != 0)
					queryConditionShopCart.setUserObj(userInfoList.get(arg2-1).getUser_name()); 
				else
					queryConditionShopCart.setUserObj("");
			}
			@Override
			public void onNothingSelected(AdapterView<?> arg0) {}
		});
		...
		btnQuery.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				try {
					...
					//传输的内容仍然是键值对的形式
					bundle.putSerializable("queryConditionShopCart", queryConditionShopCart);
