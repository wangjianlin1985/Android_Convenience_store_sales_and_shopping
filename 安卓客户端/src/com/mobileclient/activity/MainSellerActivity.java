...
public class MainSellerActivity extends MyTabActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		TabSpec secondSpec = tabHost.newTabSpec(SECOND_TAB).setIndicator(SECOND_TAB)
				.setContent(new Intent(this,ProductSellerListActivity.class));
		Button secondBtn = (Button)findViewById(R.id.secondBtn);
		secondBtn.setText("商品管理");
		/*第三tab页*/
