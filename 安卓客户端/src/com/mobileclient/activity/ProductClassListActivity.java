				...
				handler.post(new Runnable() {
					...
					public void run() {
						...
						adapter = new ProductClassSimpleAdapter(ProductClassListActivity.this, list,
	        					...
	        					new String[] { "classId","className","classDesc" },
	        					new int[] { R.id.tv_classId,R.id.tv_className,R.id.tv_classDesc,},lv);
	...
	private List<Map<String, Object>> getDatas() {
		...
		try {
			...
			for (int i = 0; i < productClassList.size(); i++) {
				...
				map.put("classDesc", productClassList.get(i).getClassDesc());
				list.add(map);
			}
		} catch (Exception e) { 
