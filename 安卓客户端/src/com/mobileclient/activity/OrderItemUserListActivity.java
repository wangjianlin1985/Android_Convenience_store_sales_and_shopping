...
public class OrderItemUserListActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		search.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				intent.setClass(OrderItemUserListActivity.this, OrderItemQueryActivity.class);
		...
		add_btn.setOnClickListener(new android.view.View.OnClickListener(){ 
			...
			public void onClick(View arg0) {
				Intent intent = new Intent();
				intent.setClass(OrderItemUserListActivity.this, OrderItemAddActivity.class);
		...
		queryConditionOrderItem = new OrderItem();
		queryConditionOrderItem.setOrderObj(orderNo);
	...
	private void setViews() {
		...
		new Thread(){
			...
			public void run() {
				...
				handler.post(new Runnable() {
					...
					public void run() {
						dialog.cancel();
						adapter = new OrderItemSimpleAdapter(OrderItemUserListActivity.this, list,
		...
		lv.setOnItemClickListener(new OnItemClickListener(){
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,long arg3) {
            	...
            	Intent intent = new Intent();
            	intent.setClass(OrderItemUserListActivity.this, ProductDetailActivity.class);
	...
	public boolean onContextItemSelected(MenuItem item) {
		if (item.getItemId() == 0) {  //编辑订单条目信息
			...
			Intent intent = new Intent();
			intent.setClass(OrderItemUserListActivity.this, OrderItemEditActivity.class);
			Bundle bundle = new Bundle();
	...
	protected void dialog() {
		Builder builder = new Builder(OrderItemUserListActivity.this);
